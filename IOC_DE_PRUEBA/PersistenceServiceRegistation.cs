...
namespace IOC_DE_PRUEBA
{
    public static class PersistenceServiceRegistation
    {
        public static void AddPersistenceInfrastructure(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddStereotype(typeof(IGenericRepository<>), typeof(GenericRepository<>).Assembly);
            #endregion
        }
    }
}
